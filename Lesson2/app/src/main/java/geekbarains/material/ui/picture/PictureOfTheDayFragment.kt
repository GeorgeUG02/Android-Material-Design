...
import geekbarains.material.ui.settings.SettingsThemeActivity
    ...
    private fun renderData(data: PictureOfTheDayData) {
        when (data) {
            is PictureOfTheDayData.Success -> {
                ...
                chip_group.setOnCheckedChangeListener { chipGroup, position ->run{if (position==R.id.Photo) image_view.load(url) {
                    lifecycle(this@PictureOfTheDayFragment)
                    error(R.drawable.ic_load_error_vector)
                    placeholder(R.drawable.ic_no_photo_vector) }
                    if(position==R.id.HDPhoto) image_view.load(hdurl) {
                    lifecycle(this@PictureOfTheDayFragment)
                    error(R.drawable.ic_load_error_vector)
                    placeholder(R.drawable.ic_no_photo_vector)}}}
